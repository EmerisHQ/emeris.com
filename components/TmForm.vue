      ...
      <div class="container">
        <transition name="fade" mode="out-in">
          ...
          <div
            v-if="state === 'success'"
            key="success"
            class="bottom__state tm-rf0 tm-lh-copy tm-text-center"
          >
          ...
          <div v-else key="default">
            <label
              class="
                bottom__get-notified
                tm-rf0 tm-lh-copy tm-bold tm-measure-narrow tm-title
              "
              for="field-email"
            >
              Sign up to be notified about Emeris updates
            </label>
            <form
              :action="url"
              method="POST"
